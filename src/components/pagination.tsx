...
export function Pagination({page, pages, items, per_page}: PaginationProps) {
  ...
  return (
    <div className="flex text-sm items-center justify-between text-zinc-500">
        <span>Showing {per_page} of {items} items</span>
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-2">
          <span>Rows per page</span>

          <Select defaultValue="10" onValueChange={(e) => changePerPage(e)}>
